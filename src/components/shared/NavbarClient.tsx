                                    ...
                                    <>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            >
                                                ...
                                                {user &&
                                                    authenticatedRoutes[user.role].map(
                                                        (route) => (
                                                            <DropdownMenuItem
                                                                key={route.href}
                                                                asChild
                                        ...
                                        <nav className="flex-1 px-2">
                                            {navLinks.map((link) => (
                                                <Link
                                                    ...
                                                    className={
                                                        pathname === link.href
                                                            ? "flex items-center px-3 py-3 rounded-lg mb-1 bg-blue-50 text-blue-600"
                                                            : "flex items-center px-3 py-3 rounded-lg mb-1 text-gray-700 hover:bg-gray-50"
                                                    }
                                                >
                                                    {link.name}
                                                </Link>
                                            ...
                                            {token && (
                                                <Link
                                                    ...
                                                    className={
                                                        pathname === "/wishlist"
                                                            ? "flex items-center justify-between px-3 py-3 rounded-lg mb-1 bg-blue-50 text-blue-600"
                                                            : "flex items-center justify-between px-3 py-3 rounded-lg mb-1 text-gray-700 hover:bg-gray-50"
                                                    }
                                                >
