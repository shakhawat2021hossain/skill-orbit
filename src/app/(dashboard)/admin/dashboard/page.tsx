...
const mockData = {
  ...
  recentActivities: [
    { id: "1", type: "user_signup", user: "john_doe", action: "New user registration", time: "5 minutes ago", status: "success" },
    { id: "2", type: "course_created", user: "instructor_sarah", action: "New course published", time: "2 hours ago", status: "success" },
    { id: "3", type: "payment_failed", user: "student_456", action: "Payment processing failed", time: "4 hours ago", status: "warning" },
    { id: "4", type: "support_ticket", user: "user_789", action: "New support ticket opened", time: "6 hours ago", status: "pending" },
    { id: "5", type: "content_review", user: "moderator_1", action: "Course awaiting approval", time: "1 day ago", status: "pending" }
  ],
  topInstructors: [
    { id: "1", name: "Sarah Johnson", courses: 12, students: 2345, revenue: 45200, rating: 4.9 },
    { id: "2", name: "Mike Chen", courses: 8, students: 1876, revenue: 38900, rating: 4.8 },
    { id: "3", name: "Alex Rivera", courses: 6, students: 1543, revenue: 31200, rating: 4.7 }
  ],
  recentCourses: [
    { id: "1", title: "React Masterclass", instructor: "Sarah Johnson", students: 145, price: 89.99, status: "published" },
    { id: "2", title: "Node.js Backend", instructor: "Mike Chen", students: 98, price: 99.99, status: "published" },
    { id: "3", title: "UI/UX Design", instructor: "Alex Rivera", students: 76, price: 79.99, status: "pending" }
  ]
};
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${mockData.platformStats.totalRevenue.toLocaleString()}</p>
                </div>
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="text-green-600 font-medium">+{mockData.platformStats.monthlyGrowth}%</span>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{mockData.platformStats.totalUsers.toLocaleString()}</p>
                </div>
              ...
              <div className="text-sm text-gray-500">
                <span className="font-medium">{mockData.platformStats.activeStudents.toLocaleString()}</span> active students
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{mockData.platformStats.totalCourses}</p>
                </div>
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="font-medium">{mockData.platformStats.avgRating}</span>
                <span className="text-gray-500 ml-2">avg rating</span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{mockData.platformStats.pendingApprovals}</p>
                </div>
